...
public class BoardController {
	...
	}//list를 요청하면서 pageNum이라는 변수에 1이라는 값을 가지고 가겠다는 의미 = redirect:list?pageNum=1
	...
	//@PathVariable String pageNum: 호출하면서 받은 pageNum값을 어노테이션을 통해 받아 pageNum매개 변수에 저장
	...
	public String view(@PathVariable int num, @PathVariable String pageNum, Model model) {
		...
		Board board = bs.select(num); // 부모글에 대한 상세정보 구해옴
